...
LOG_DIR = 'logs/'
DATA_PROPERTY_DIR = 'data_provider/data/'
...
for data_name in DATASET_LIST:
    TRAIN_DATASET[data_name] = os.path.join(DATASET_DIR, data_name, data_name + '_train.npy')
    TEST_DATASET[data_name] = os.path.join(DATASET_DIR, data_name, data_name + '_test.npy')
    TEST_LABEL[data_name] = os.path.join(DATASET_DIR, data_name, data_name + '_test_label.npy')
