...
import data_provider.config as config
...
def estimate(test_data, model, post_activation, out_dim, batch_size, window_sliding, divisions,
    ...
    window_size = model.input_encoder_length * model.patch_size
    print('window_size:', window_size)
    print('input_encoder_length:', model.input_encoder_length)
...
def main(options):
    ...
    print('Save results to', outfile)
    np.save(outfile, output_values)

# Run: # python3 estimate_test.py --dataset=SMAP --model=model.pt --state_dict= state_dict.pt
# Example
# python3 estimate_test.py --dataset=SMAP --model=/home/andrew/github/ADFormer/logs/SMAP_BERT/model.pt --state_dict=/home/andrew/github/ADFormer/logs/SMAP_BERT/state/state_dict_step_epoch_10_iter4500.pt
# Then run:
# python3 compute_metrics.py --dataset=SMAP --result=/home/andrew/github/ADFormer/logs/SMAP_BERT/state/state_dict_step_epoch_10_iter4500_results.npy
